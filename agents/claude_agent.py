...
class ClaudeAgent:
    ...
    def _locate_with_claude(
        ...
        prompt = (
            ...
            "cause.\n\n"
            "A commit that ADDS a function or method should be labeled \"introduced\" (not "
            "\"legacy\") when the buggy behavior is intrinsic to that function as written — for "
            "example, adding a damage method without bounds checking is \"introduced\", even if "
            "other commits later call that method. The introducing commit is causally upstream "
            "of the calling commit; calling commits are \"legacy\".\n\n"
